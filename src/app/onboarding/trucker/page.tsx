...
const steps = [
  ...
  { key: "vehicle", label: "Add your vehicle" },
  { key: "payment", label: "Add payment method" },
  { key: "book", label: "Book your first parking spot" },
];
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 py-8 px-4">
      <div className="w-full max-w-lg bg-white rounded-2xl shadow-xl p-8">
        ...
        <p className="text-gray-600 mb-6 text-center">Let's get you ready to find and book parking.</p>
        <div className="mb-6">
